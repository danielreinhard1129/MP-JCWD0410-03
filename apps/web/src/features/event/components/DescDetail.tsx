    ...
    <div>
      <div className="container mt-[30px] px-6 lg:container lg:flex lg:max-w-7xl lg:flex-row lg:justify-between lg:px-0">
        ...
        <div className="hidden lg:block">
          <div className="lg:sticky lg:top-[80px] lg:w-[400px] lg:rounded-xl lg:border-[1.5px] lg:px-5 lg:py-8 lg:shadow-md">
      ...
      {/* FAB Mobile */}
      <div className="fixed bottom-0 flex w-full flex-row justify-center border-t-[1.5px] border-gray-200 bg-white px-6 py-4 lg:hidden">
